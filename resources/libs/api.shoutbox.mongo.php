<?php
	...
	$GLOBALS['api']['mongo']['tables']['shouts'] = [
		...
		,'shoutMailing'=>'TEXT'
		,'shoutAuthor'=>'INTEGER NOT NULL'
		,'shoutTags'=>'TEXT'
		,'shoutModes'=>'TEXT'
		,'shoutIP'=>'TEXT NOT NULL'
		,'shoutImages'=>'TEXT'
		,'shoutRating'=>'TEXT'
		,'shoutVotesCount'=>'INTEGER'
	...
	class shoutTB extends _mongo{
		public $table = 'shouts';
		public $search_fields = ['shoutTitle','shoutText'];
