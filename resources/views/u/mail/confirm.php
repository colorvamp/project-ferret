	<div style="background:#eee;padding:20px;">
		...
		<div style="background:white;border-bottom:1px solid #999;padding:10px;margin-top:20px;border-radius:4px;">
			...
			<p>HotelVamp ha recibido un petición para crear un usuario usando esta cuenta de correo ({%userOB_userMail%})</p>
			...
			<div><a 
				...
				href="{%w.indexURL%}/u/remember/{%userOB_userMail%}/{%userOB_userCode_remember%}">Confirmar</a></div>
